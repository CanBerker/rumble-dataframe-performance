...
git co master
build
cp target/${rddBinaryName} ~/Project/sparksoniq-dataframe-perf-v1/bin/${rddBinaryName}

cd ~/Project/sparksoniq
git co develop-dataframes
build
cp target/${rddBinaryName} ~/Project/sparksoniq-dataframe-perf-v1/bin/${dfBinaryName}
...
# 500k - short
noglob spark-submit --master local[*] --deploy-mode client --driver-memory 6G ./bin/${rddBinaryName} --query-path ./query1/short500k-query1.jq --output-path ./query1/short500k-query1-output.txt --log-path ./query1/short500k-query1-log.txt --result-size 16000000
noglob spark-submit --master local[*] --deploy-mode client --driver-memory 6G ./bin/${dfBinaryName} --query-path ./query1/short500k-query1.jq --output-path ./query1/short500k-df-query1-output.txt --log-path ./query1/short500k-df-query1-log.txt --result-size 16000000

# 5m - medium
noglob spark-submit --master local[*] --deploy-mode client --driver-memory 6G ./bin/${rddBinaryName} --query-path ./query1/medium5m-query1.jq --output-path ./query1/medium5m-query1-output.txt --log-path ./query1/medium5m-query1-log.txt --result-size 16000000
noglob spark-submit --master local[*] --deploy-mode client --driver-memory 6G ./bin/${dfBinaryName} --query-path ./query1/medium5m-query1.jq --output-path ./query1/medium5m-df-query1-output.txt --log-path ./query1/medium5m-df-query1-log.txt --result-size 16000000
